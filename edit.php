...
if ( $_SERVER['REQUEST_METHOD'] == 'GET' ){
    ...
    do{
        if(empty($name) || empty($email) || empty($telephone) || empty($joined_date) || empty($current_route) || empty($comment)){
            $errorMessage = "All the fields are required";
            break;
        }

        $sql = "UPDATE test " . "SET name = '$name', email = '$email', telephone = '$telephone', joined_date = '$joined_date', current_route = '$current_route', comment = '$comment'" . 
                "WHERE id = $id";
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-primary" href="/php_anushka/index.php" role="button">Back to List</a>
                </div>
            </div>
        </form>
    </div>
